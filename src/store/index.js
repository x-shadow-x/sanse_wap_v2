...
const state = {
    userId: '304014', // 全局使用的userid，个人中心页几乎各项数据的获取都需要此字段~同时此字段也被用来判断用户是否已经登录~默认为0表示没有登录
    cookieId: '23456006805d970d5438a354dc019fc295614979', // 一个随机id~因在多个页面获取数据时需要用到故作全局配置~默认为 0
    routerList: {
        '/home': 0,
